var provinceList = [{
		...
		cityList: [{
			name: '市辖区',
			areaList: ['东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云区', '延庆区']
		}]
	},
	{
		name: '上海市',
		cityList: [{
			name: '市辖区',
			areaList: ['黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '南汇区', '奉贤区', '崇明区']
		}]
	},
	{
		name: '天津市',
		cityList: [{
			name: '市辖区',
			areaList: ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '塘沽区', '汉沽区', '大港区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '宁河区', '静海区', '蓟州区']
		}]
	},
	{
		name: '重庆市',
		cityList: [{
				name: '市辖区',
				areaList: ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '涪陵区', '永州区', '璧山区', '大足区', '綦江区', '江津区', '合川区', '黔江区', '长寿区', '南川区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区']
			},
			{
				name: '县',
				areaList: ['城口县', '丰都县', '垫江县', '忠  县', '云阳县', '奉节县', '巫山县', '巫溪县']
			},
			{
				name: '自治县',
				areaList: ['石柱土家族自治县', '秀山土家族苗族自治县', '西阳土家族苗族自治县', '彭水苗族土家族自治县']
			}
		]
	},
	{
	...
	},
	{
		...
		cityList: [{
			...
			{
				name: '三亚市',
				areaList: ['市辖区', '吉阳区', '崖州区', '天涯区', '海棠区']
			},
			{
				name: '三沙市',
				areaList: ['西沙群岛', '中沙群岛', '南沙群岛']
			},
			{
				name: '儋州市',
				areaList: ['那大镇', '南丰镇', '雅星镇', '和庆镇', '大成镇', '新州镇', '光村镇', '东城镇', '中和镇', '峨蔓镇', '兰洋镇', '王五镇', '排浦镇', '海头镇', '木棠镇', '白马井镇', '三都办事处']
			},
			{
				name: '省直辖县级行政单位',
				areaList: ['五指山市', '琼海市', '文昌市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙黎族自治县', '昌江黎族自治县', '乐东黎族自治县', '陵水黎族自治县', '保亭黎族苗族自治县', '琼中黎族苗族自治县']
			}
		]
	},
	{
		...
		cityList: [{
				name: '台北市',
				areaList: ['内湖区', '南港区', '中正区', '万华区', '大同区', '中山区', '松山区', '大安区', '信义区', '文山区', '士林区', '北投区']
			},
			{
				name: '新北市',
				areaList: ['板桥区', '汐止区', '新店区', '永和区', '中和区', '土城区', '树林区', '三重区', '新庄区', '芦洲区', '瑞芳区', '三峡区', '莺歌区', '淡水区', '万里区', '金山区', '深坑区', '石碇区', '平溪区', '双溪区', '贡寮区', '坪林区', '乌来区', '泰山区', '林口区', '五股区', '八里区', '三芝区', '石门区']
			},
			{
				name: '桃园市',
				areaList: ['桃园区', '中坜区', '平镇区', '八德区', '杨梅区', '芦竹区', '大溪区', '龙潭区', '龟山区', '大园区', '观音区', '新屋区', '复兴区']
			},
			{
				name: '台中市',
				areaList: ['中区', '东区', '南区', '北区', '北屯区', '西屯区', '南屯区', '太平区', '大里去', '雾峰区', '乌日区', '丰原区', '后里区', '潭子区', '大雅区', '神冈区', '石冈区', '东势区', '新社区', '和平区', '大肚区', '沙鹿区', '龙井区', '梧栖区', '清水区', '大甲区', '外埔区', '大安区']
			},
			{
				name: '台南市',
				areaList: ['中西区', '东区', '南区', '西区', '北区', '安平区', '安南区', '永康区', '归仁区', '新化区', '坐镇区', '玉井区', '楠西区', '南化区', '仁德区', '关庙区', '龙崎区', '宫田区', '麻豆区', '徍里区', '西港区', '七股区', '将军区', '学甲区', '北门区', '新营区', '后壁区', '白河区', '东山区', '六甲区', '下营区', '柳营区', '盐水区', '善化区', '大内区', '山上区', '新市区', '安定区']
			},
			{
				name: '高雄市',
				areaList: ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '大寮区', '鸟松区', '林园区', '仁武区', '大树区', '大社区', '冈山区', '路竹区', '桥头区', '梓官区', '弥陀区', '永安区', '永安区', '燕巢区', '阿莲区', '茄萣区', '湖内区', '旗山区', '美浓区', '内门区',
					'杉林区', '甲仙区', '六龟区', '茂林区', '桃源区', '那玛夏区'
				]
			}, {
				name: '基隆市',
				areaList: ['中正区', '七堵区', '暖暖区', '仁爱区', '中山区', '安乐区', '信义区']
			},
			{
				name: '新竹市',
				areaList: ['东区', '北区', '香山区']
...
for (var i = 0; i < provinceList.length; i++) {
    ...
    var option = new Option(provinceName, i);
...
layui.use(['form'], function () {
    ...
    form.on('select(province)', function (data) {
        ...
        var provinceName = provinceArr[index];
        for (var n = 0; n < provinceList.length; n++) {
            if (provinceList[n].name == provinceName) {
                cityList = provinceList[n].cityList;
                ci.html("");
                ar.html("");
                for (var c = 0; c < cityList.length; c++) {
                    var cityName = cityList[c].name;
                    cityArr[c] = cityName;
                    var option = new Option(cityName, c);
    ...
    form.on('select(city)', function (data) {
        ...
        for (var c = 0; c < cityList.length; c++) {
            if (cityList[c].name == cityName) {
                areaList = cityList[c].areaList;
                ar.html("");
                console.log(areaList);
                for (var a = 0; a < areaList.length; a++) {
                    var areaName = areaList[a];
                    var option = new Option(areaName, a);
