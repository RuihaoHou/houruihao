				...
				<div class="layui-form">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline"
							...
							<select name="did" lay-verify="required" lay-search=""
								id="dsearch">
							</select>
						</div>
						<!--姓名 -->
						...
						<div class="layui-input-inline"
							style="margin-left: -25px; margin-top: 4px">
							<input name="name" autocomplete="off" placeholder="请输入姓名"
						...
						<div class="layui-input-inline" style="margin-top: 4px">
							<input name="cardId" autocomplete="off" placeholder="请输入身份证"
								class="form-control" type="text" id="cardId">
						</div>
					</div>
					<!--第二行 -->
					<div class="layui-form-item">
						...
						<div class="layui-input-inline"
							...
							<input name="phone" autocomplete="off" placeholder="请输入手机号"
