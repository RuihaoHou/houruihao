				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"> <i class="fa fa-user"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" href="user/addUser?flag=1">添加用户</a>
							</li>
						</ul></li>
					<li><a href="#"> <i class="fa fa-home"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" href="dept/addDept?flag=1">添加部门</a>
							</li>
						</ul></li>
					...
					<li><a href="#"><i class="fa fa-users"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem"
								href="employee/addEmployee?flag=1">添加员工</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-tv"></i> <span
							class="nav-label">公告管理</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="${ctx}/notice/selectNotice">公告查询</a></li>
							<li><a class="J_menuItem" href="${ctx}/notice/addNotice?flag=1">添加公告</a></li>
							<li><a class="J_menuItem" href="${ctx}/notice/addEmail?flag=1">发送邮件</a></li>
							<li><a class="J_menuItem" href="${ctx}/notice/addMsg?flag=1">发送短信</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-cloud-download"></i> <span
							class="nav-label">下载中心</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="${ctx}/doc/selectDocument">文档查询</a></li>
							<li><a class="J_menuItem" href="${ctx}/doc/addDocument">上传文档</a></li>
						</ul></li>
					...
					<li><a href="#"><i class="fa fa fa-bar-chart-o"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="${ctx}/poi/createPoi">报表生成</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
