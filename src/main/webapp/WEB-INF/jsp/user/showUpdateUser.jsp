...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/flat-ui.js" type="text/javascript" charset="UTF-8"></script>
    <style type="text/css">
        .form-group-sm {
            margin-left: 10px;
        }
                    ...
                    <tr>
                        <td class="font3 fftd">
                            <div class="form-group-sm">
                                <label>姓&nbsp;名:<input class="form-control" type="text" name="username"
                                                       id="username" value="${user.username}" lay-verify="username"></label>&nbsp;&nbsp;
                                <label>状&nbsp;态:<input class="form-control" type="text" name="status"
                                                       id="status" value="${user.status}" lay-verify="status"></label>
                            </div>
                            <div class="form-group-sm">
                                <label>登录名:<input class="form-control" type="text" name="loginname"
                                                  id="loginname" value="${user.loginname}" lay-verify="loginname"></label>&nbsp;&nbsp;
                                <label>密&nbsp;码:<input class="form-control" type="text" name="password"
                                                       id="password" value="${user.password}"
                                                       readonly="readonly" lay-verify="password"></label>
                            </div>
                            <div class="form-group-sm">
