    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-group" style="margin-bottom:0px;">
                <label class="col-sm-2 control-label" style="text-align: right; margin-top:5px">职位名称：</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="name" id="search_jname"/>
                </div>
...
<script type="text/javascript">
    ...
    $("#btn_add").click(function () {
        window.location.href = "${ctx}/job/addJob?flag=1";
    })
    ...
    $("#btn_delete").click(function () {
        ...
        if (ids.length < 1) {
            ...
            layer.confirm('确定删除这些职位吗?？', {
                btn: ['是的', '按错了'] //可以无限个按钮
            }, function () {
                //确定按钮的回调函数
                var url = "${ctx}/job/removeJob";
                var params = {
                    flag: 2,
                    ids: ids
                }
                $.ajax({
                    ...
                    dataType: "json",
                    error: function () {
                        $("#table").bootstrapTable("refresh", {url: '${ctx}/bjson'});
                    }
                })
            })
        }
    ...
    function deleteone(id) {
        layer.confirm('确定删除这个职位吗?？', {
            btn: ['是的', '按错了'] //可以无限个按钮
        }, function () {
            //确定按钮的回调函数
            window.location.href = "${ctx}/job/removeJob?flag=1&id=" + id;
        })
    }
        ...
        inint() {
            ...
            this.obj.bootstrapTable({
                ...
                columns: [
                    ...
                    {field: 'remanrk', title: '详细信息'},
                    {
                        field: 'tool', title: '操作', align: 'center',
                        formatter: function (value, row, index) {
                            var element =
                                "<a  data-id='" + row.id + "' href='${ctx}/job/updateJob?flag=1&id=" + row.id + "' class='btn btn-info btn-sm'>编辑</a> &nbsp;" +
