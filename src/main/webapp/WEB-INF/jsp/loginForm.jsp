...
<head>
    ...
    <link href="${ctx}/js/metronic/plugins/bootstrap/css/bootstrap-responsive.min.css"
            rel="stylesheet" type="text/css"/>
    <link href="${ctx}/js/metronic/plugins/font-awesome/css/font-awesome.min.css"
            rel="stylesheet" type="text/css"/>
...
<div class="page-lock">
    <div class="page-logo" style="margin-bottom: 2px">
        <a class="brand" href="login.html"
           style="font-size: 22px; color: #FFF;"> 人事管理系统</a>
    </div>
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-user"></i> <input
                                ...
                                id="loginname" name="loginname" value="${cookie['loginName'].value}">
                    </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="input-icon left"><input
                                class="m-wrap placeholder-no-fix" type="checkbox" style="color:red" id="ishave"
                                name="ishave" value="remeber" ${cookie['remeber'].value}/>记住账号
                        </div>
                    </div>
                </div>
            </div>
